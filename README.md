...
| 阶段 | WUDAX 做什么 | 用户得到什么 |
| :--- | :--- | :--- |
| 行前 | 解析 GPX，与个人最难经历、海拔和时长交叉比较 | 挑战评级、关键风险点、补给与装备清单 |
| 去起点 | 只显示距起点距离与引导线，不提前累计正式行程 | 清晰的起点门控，避免 GPS 漂移误开行程 |
| 行中 | 匹配路线进度，结合心率、补给、日落、膝痛和主观疲劳 | 低打扰提醒与可解释的受控行动 |
| 行后 | 汇总实际距离、耗时、事件和失控点 | 训练建议与逐步校准的个人能力档案 |
